...
# --- Kaggle CLI auth + download + unzip (Colab) ---
!pip -q install kaggle

from google.colab import files
print("Upload kaggle.json (Kaggle API key)")
...
!kaggle datasets download -d rhythmroy/sen12flood-flood-detection-dataset -p /content/data -q

# Unzip into a stable raw directory (safe to re-run)
!mkdir -p /content/data/sen12flood
!unzip -n -q /content/data/sen12flood-flood-detection-dataset.zip -d /content/data/sen12flood

# Define paths for the rest of your code
from pathlib import Path
RAW_DIR = Path("/content/data/sen12flood")
OUT_DIR = Path("/content/clean_sen12")
